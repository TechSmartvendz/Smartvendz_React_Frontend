...
function Machine_manage() {
    ...
    {name:"Tessolve SJP ",EmployeeName:"Vinod Kumar HSR",officename:"Tessolve SJP"},
    {name:"NSL india university",EmployeeName:"Venkatesh",officename:"NSL india university"},
...
<td><button className='mm_edit_btn'>Edit</button></td>
</tr>
  )
