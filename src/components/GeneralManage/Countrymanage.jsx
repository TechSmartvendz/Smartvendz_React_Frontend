  ...
  return (
    <React.Fragment>
      <div className="add-user-container">
        {/* {showAlert ? (
          <div className="alert-msg">Country Added successfully</div>
        ) : (
          ""
        )}
        {errorAlert ? (
          <div className="alert-errormsg">Country Added Already</div>
        ) : (
          ""
        )} */}
        <div className="headingdiv">
          <span className="componet-title" style={{ marginLeft: "12px" }}>
            Country Manage
          </span>
        ...
        <form className="flex-row form-2col-ver" onSubmit={handleSubmit}>
          ...
          <div className="general-manage-div">
            ...
            <button className="submit-btn">
              {par ? <span>Update</span> : <span>Add New</span>}
            </button>
          </div>
        </form>
